...
"1N6AA0EDXFN868772", "WBADW3C59DJ422810");
    ...
    <h4>Nimed</h4>
    <?php
        $nimed = array('mari', 'kati', 'malle', 'minni', 'xari', 'liisa', 'karin', 'kerli', 'annette');
        sort($nimed);
...
<br>
    ...
    $esimenenimi = $nimed[0];
    $perenimi = end($nimed);
    echo "Eesnimi on $esimenenimi <br>";
    echo "Perekonnanimi on $perenimi<br>";
    ?>

    <h4>Google</h4>
    <form action="#">
        otsi google: <input type="text" name="otsi">
        <input type="submit" value="otsi google">
    </form>
    <?php
